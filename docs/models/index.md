...
## :ardis-pathogen: Interactive epidemic models
...
## :ardis-pathogen: Malaria

- This [mathematical model of red blood cell (RBC) dynamics in a malaria infection](https://rgmoss.pages.gitlab.unimelb.edu.au/malaria-spleen-rbc-loss/) includes the spleen as a separate model compartment, as presented in [this paper](https://doi.org/10.1371/journal.pcbi.1013865).

## :ardis-renal: Renal physiology
...
This has led to a proliferation of [semantic](https://sed-ml.org/) [markup](https://sbml.org/) [languages](https://www.cellml.org/) and [detailed](https://co.mbine.org/author/miriam/) [guidelines](https://en.wikipedia.org/wiki/Minimum_information_about_a_simulation_experiment) for describing models and *in silico* experiments.
