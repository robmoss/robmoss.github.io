...
```elisp linenums="1", hl_lines="62-65"
...
You can also ensure that the REPL appears in a [separate frame](https://haskell.github.io/haskell-mode/manual/latest/Interactive-Haskell.html), but I'm not certain whether I want this behaviour.
