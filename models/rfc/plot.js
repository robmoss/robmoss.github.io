...
var width = document.getElementsByClassName('figure')[0].offsetWidth;
var height = 0.75 * width;
var sm = { w: width - 75, h: height - 50,
           margin_x: 75, margin_y: 50 };

var tbl = Plot.study_table("studies.csv", "body"),
    pjna = Plot.create("jna.csv", "jna_hull.csv",
                       sm, na_lbl, "#jna"),
    pjv = Plot.create("jv.csv", "jv_hull.csv",
                      sm, v_lbl, "#jv");
